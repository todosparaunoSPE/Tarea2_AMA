...
st.markdown("**i) ¿Cómo cambia el modelo al aumentar la penalización en L1 y L2?**")
st.write(f"""
...
st.markdown("**ii) Comenta los resultados obtenidos y discute si la regularización mejoró o no el desempeño del modelo.**")
st.write(f"""
- **Comparación de RMSE**:
  - **OLS**: {rmse_ols:.4f}
  - **Ridge**: {rmse_ridge:.4f}
...
st.markdown("**iii) ¿Qué problemas pueden evitarse con el uso de regularización en modelos de regresión?**")
st.write(f"""
